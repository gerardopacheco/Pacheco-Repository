...
CREATE TABLE `funcionalidad` (
  `id_fnl` int(11) NOT NULL,
  `nomb_fnl` varchar(50) NOT NULL,
  `icn_fnl` varchar(30) NOT NULL,
  `acc_fnl` varchar(50) DEFAULT NULL,
  `idpd_fnl` int(11) NOT NULL,
  PRIMARY KEY (`id_fnl`)
...
INSERT INTO `funcionalidad` VALUES (1,'Acciones','ui-icon-engine',NULL,0),(2,'Gestionar Paciente','ui-icon-person','gestionar_paciente',1),(3,'Gestionar Usuario','ui-icon-person','gestionar_usuario',1);
